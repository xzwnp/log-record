...
//				}
				log.info("操作名称: {} ,traceId: {} ,操作描述: {} ,耗时: {}ms ,返回值: {}", operateName, dto.getTraceId(), content, cost, returnValueString);
			} else {
				log.info("操作名称: {} ,traceId: {} ,操作描述: {} ,耗时: {}ms", operateName, dto.getTraceId(), content, cost);
			}
			//日志持久化
			saveOperateLog(dto);
		} catch (LogRecordException e) {
